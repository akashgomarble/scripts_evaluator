...
EVALUATION_QUESTIONS = {
    "creativity": [
        "Does the ad script immediately grab attention within the first few words/visual description?",
        "Is the central concept or idea behind the ad novel and not commonly seen in similar advertisements?",
        "Does the execution of the idea feel fresh and imaginative?",
        "Does the script use unexpected elements or juxtapositions to create intrigue?",
        ...
        "Are the first 3 seconds designed to interrupt the audience's scrolling behavior?",
        "Does the ad use an unexpected or intriguing element to grab attention?",
        "Is there a strong hook that makes the audience want to learn more?",
        "Is the core concept of the ad unlike typical ads in its category?",
        "Does the ad use any unexpected elements (humor, surprise, etc.)?",
        "Does the ad's visual concept feel fresh and innovative?",
        ...
        "Does the ad spark curiosity or intrigue?"
    ],
    "emotional_appeal": [
